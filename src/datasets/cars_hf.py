# Stanford Cars dataset loader using Hugging Face
# This replaces the broken Stanford download links
...
# Original Stanford Cars class names in the correct order (from cars_meta.mat)
# This is critical for matching the classification head's expected label order
STANFORD_CARS_CLASSNAMES = [
    ...
    'Bugatti Veyron 16.4 Coupe 2009', 'Buick Regal GS 2012', 'Buick Rainier SUV 2007',
    'Buick Verano Sedan 2012', 'Buick Enclave SUV 2012', 'Cadillac CTS-V Sedan 2012',
    ...
    'GMC Terrain SUV 2012', 'GMC Savana Van 2012', 'GMC Yukon Hybrid SUV 2012',
    'GMC Acadia SUV 2012', 'GMC Canyon Extended Cab 2012', 'Geo Metro Convertible 1993',
    ...
    'Scion xD Hatchback 2012', 'Spyker C8 Convertible 2009', 'Spyker C8 Coupe 2009',
    'Suzuki Aerio Sedan 2007', 'Suzuki Kizashi Sedan 2012', 'Suzuki SX4 Hatchback 2012',
    'Suzuki SX4 Sedan 2012', 'Tesla Model S Sedan 2012', 'Toyota Sequoia SUV 2012',
    'Toyota Camry Sedan 2012', 'Toyota Corolla Sedan 2012', 'Toyota 4Runner SUV 2012',
...
class HuggingFaceCars(Dataset):
    """Stanford Cars dataset loaded from Hugging Face."""
    ...
    def __init__(self, split='train', transform=None):
        ...
        print(f"Loading Stanford Cars {split} split from Hugging Face...")
        self.ds = load_dataset('tanganke/stanford_cars', split=split)
        self.transform = transform
        
        # The tanganke/stanford_cars dataset uses integer labels 0-195
        # that should already match the original Stanford Cars ordering
        self.classes = STANFORD_CARS_CLASSNAMES
    ...
    def __getitem__(self, idx):
        ...
        # The HuggingFace dataset's 'label' should be an integer 0-195
        label = item['label']
...
class Cars:
    """Stanford Cars dataset wrapper compatible with the evaluation code."""
    ...
    def __init__(self,
        ...
        print("Loading Stanford Cars from Hugging Face (original Stanford URLs are dead)...")
        
        self.train_dataset = HuggingFaceCars('train', transform=preprocess)
        ...
        self.test_dataset = HuggingFaceCars('test', transform=preprocess)
        ...
        # Use the official class names
        self.classnames = [name.replace('_', ' ') for name in STANFORD_CARS_CLASSNAMES]
        
        print(f"Loaded {len(self.train_dataset)} training and {len(self.test_dataset)} test images")
