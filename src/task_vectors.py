...
class NonLinearTaskVector(_TaskVector):
    ...
    def _load_checkpoint(self, checkpoint):
        ...
        # Patch for older checkpoints: add missing attributes to VisionTransformer
        self._patch_vision_transformer(model)
        
        return model
    
    def _patch_vision_transformer(self, module):
        ...
        for child in module.children():
            self._patch_vision_transformer(child)
